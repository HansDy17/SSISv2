...
course_code = tk.Label(course_detail_frame,text="Course Code:", font=("Times", 12), bg="black", foreground="white")
...
cc_entry.place(x=110, y=20, width=250, height=30)

COURSE_NAME = StringVar()
courname_label = tk.Label(course_detail_frame,text="Course:", font=("Times", 14), bg="black", foreground="white")
...
courname_entry.place(x=110, y=70, width=250, height=30)

#Label with Entry for Detail Frame

id_label = tk.Label(detail_frame,text="ID No.:", font=("Times", 14), bg="black", foreground="white")
id_label.place(x=20, y=20)
ID = StringVar()
id_entry = tk.Entry(detail_frame, textvariable=ID, bd=1,font=("Times", 16),relief=tk.SUNKEN, bg="white", foreground="black")
id_entry.place(x=110, y=20, width=250, height=30)

NAME = StringVar()
name_label = tk.Label(detail_frame,text="Name:", font=("Times", 14), bg="black", foreground="white")
...
name_entry.place(x=110, y=70, width=250, height=30)

GENDER = StringVar()
gender_label = tk.Label(detail_frame,text="Gender:", font=("Times", 14), bg="black", foreground="white")
gender_label.place(x=20, y=120)
gender_entry = ttk.Combobox(detail_frame, textvariable=GENDER,font=("Times", 14))
gender_entry["values"] = ("Male", "Female", "Prefer not to say")
gender_entry.place(x=110, y=120, width=250, height=30)

AGE = StringVar()
age_label = tk.Label(detail_frame,text="Age:", font=("Times", 14), bg="black", foreground="white")
age_label.place(x=20, y=170)
age_entry = ttk.Spinbox(detail_frame, textvariable=AGE,font=("Times", 14), from_=16, to=130)
age_entry.place(x=110, y=170, width=250, height=30)

COURSE = StringVar()
course_label = tk.Label(detail_frame,text="Cour Code:", font=("Times", 13), bg="black", foreground="white")
...
course_entry.place(x=110, y=220, width=250, height=30)

YEAR = StringVar()
yrlvl_label = tk.Label(detail_frame,text="Year Level:", font=("Times", 14), bg="black", foreground="white")
yrlvl_label.place(x=20, y=270)
yrlvl_entry = ttk.Combobox(detail_frame, textvariable=YEAR,font=("Times", 14))
yrlvl_entry["values"] = ("Freshmen", "Sophomore", "Junior", "Senior", "Masteral", "Doctorate")
yrlvl_entry.place(x=110, y=270, width=250, height=30)

EMAIL = StringVar()
email_label = tk.Label(detail_frame,text="Email:", font=("Times", 14), bg="black", foreground="white")
...
email_entry.place(x=110, y=320, width=250, height=30)
...
tk.Label(subdata_frame,text="ID Number: ", font=("Times", 14, "bold"), bg="grey", foreground="black").place(x=30, y=60)
tk.Label(subdata_frame,text="FULL NAME: ", font=("Times", 14, "bold"), bg="grey", foreground="black").place(x=30, y=110)
tk.Label(subdata_frame,text="GENDER: ", font=("Times", 14, "bold"), bg="grey", foreground="black").place(x=30, y=160)
tk.Label(subdata_frame,text="AGE: ", font=("Times", 14, "bold"), bg="grey", foreground="black").place(x=30, y=210)
tk.Label(subdata_frame,text="COURSE CODE: ", font=("Times", 14, "bold"), bg="grey", foreground="black").place(x=30, y=260)
tk.Label(subdata_frame,text="COURSE: ", font=("Times", 14, "bold"), bg="grey", foreground="black").place(x=30, y=310)
tk.Label(subdata_frame,text="YEAR LEVEL: ", font=("Times", 14, "bold"), bg="grey", foreground="black").place(x=30, y=360)
tk.Label(subdata_frame,text="EMAIL:", font=("Times", 14, "bold"), bg="grey", foreground="black").place(x=30, y=410)
...
gender1_entry["values"] = ("Male", "Female", "Prefer not to say")
...
course1_entry = tk.Entry(subdata_frame, bd=1,font=("Times", 12), bg="white", foreground="black")
course1_entry.place(x=230, y=310, width=300, height=28)
year1_entry = ttk.Combobox(subdata_frame,font=("Times", 14))
year1_entry["values"] = ("Freshmen", "Sophomore", "Junior", "Senior", "Masteral", "Doctorate")
year1_entry.place(x=230, y=360, width=300, height=28)
email1_entry = tk.Entry(subdata_frame, bd=1,font=("Times", 14), bg="white", foreground="black")
email1_entry.place(x=230, y=410, width=300, height=28)


f = tk.Frame(subdata_frame, bd=3, bg="black", width=230, height=230, relief="groove")
f.place(x=565, y=60)

pp_file = r"C:\Users\yuyun\OneDrive\Pictures\Saved Pictures\empty_profile1.png"
...
student_table = ttk.Treeview(main_frame, columns=(
  "ID", "Name", "Gender", "Course Code", "Year Level","Age", "Email"
...
class Student:
    ...
    def edit(event=None):
        ...
        courcode_entry.insert(0,values[3])
        course1_entry.insert(0, course if course else "")        
        year1_entry.insert(0, values[4])
        age1_entry.insert(0, values[5])
        email1_entry.insert(0, values[6])
...
button_frame = tk.Frame(detail_frame, bg="grey",bd=0, relief= tk.GROOVE)    
button_frame.place(x=40, y=400, width=332, height=90)

add_btn = tk.Button(button_frame,bg="black",foreground="white",text="ADD",bd=2,font=("Times", 13), width=15, command=Student.add)
add_btn.grid(row=0, column=0, padx=2, pady=2)

edit_btn = tk.Button(button_frame,bg="black",foreground="white",text="EDIT",bd=2,font=("Times", 13), width=15, command=Student.edit)
...
delete_btn = tk.Button(button_frame,bg="black",foreground="white",text="DELETE",bd=2,font=("Times", 13), width=15, command=Student.delete)
delete_btn.grid(row=1, column=0, padx=2, pady=2)

course_btn = tk.Button(detail_frame,bg="black",foreground="white",text="MANAGE COURSE",bd=2,font=("Times", 15), width=20, command=Student.mngCourse)
course_btn.place(x= 100, y= 500)

# Buttons for Course Detail Frame

course_button_frame = tk.Frame(course_detail_frame, bg="grey",bd=0, relief= tk.GROOVE)    
...
student_btn = tk.Button(course_detail_frame,bg="black",foreground="white",text="MANAGE STUDENT",bd=2,font=("Times", 15), width=20, command=Student.mngStudent)
...
save1_btn.place(x=600, y=350)
del_btn = tk.Button(subdata_frame,bg="black",foreground="white",text="DELETE",bd=2,font=("Times", 13), width=15, command=Student.delete)
del_btn.place(x=600, y=400)

for button in button_frame.winfo_children():
    button.grid_configure(padx=10, pady=5)

#search_icon = r"C:\Users\Amazing User\Pictures\search_icon.png"
search_icon = r"C:\Users\yuyun\OneDrive\Pictures\Saved Pictures\search_icon.png"
search_logo = tk.PhotoImage(file=search_icon)
root.bind('<Return>', Student.search)
search_btn = tk.Button(root, bg="black",foreground="white", text=" SEARCH STUDENT ", compound="right", image=search_logo, relief=tk.RAISED, bd=2,font=("Times", 12), width=15, command=Student.search)
search_btn.place(x=490, y=90, width=175, height=29)

search_entry = tk.Entry(root, bd=3,font=("Times", 14),relief=tk.SUNKEN, bg="white", foreground="black")
...
search_entry.place(x=665, y=90, width=250, height=29)

courList_btn = tk.Button(root, bg="black",foreground="white", text="COURSE LIST", relief=tk.RAISED, bd=2,font=("Times", 12), width=15, command=sub1data_frame.lift)
courList_btn.place(x=980, y=90, width=150, height=28)

studList_btn = tk.Button(root, bg="black",foreground="white", text="STUDENT LIST", relief=tk.RAISED, bd=2,font=("Times", 12), width=15, command=data_frame.lift)
